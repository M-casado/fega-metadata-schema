...
This directory contains JSON Schema files that are derived from HealthDCAT-AP Release 5 artefacts (including SHACL shapes and specification constraints) and curated for use in this repository.
...
- **Specification**: HealthDCAT-AP Release 5
- **Copyright** © 2025 European Union
- **Upstream page**: https://healthdataeu.pages.code.europa.eu/healthdcat-ap/releases/release-5/

## How these files were produced

1. Started from upstream [SHACL shapes](https://healthdataeu.pages.code.europa.eu/healthdcat-ap/releases/release-5/#validation-of-healthdcat-ap) (e.g., [``non-public-shapes.ttl``](https://healthdataeu.pages.code.europa.eu/healthdcat-ap/releases/release-5/html/shacl/non-public-shapes.ttl)).
...
The contents of this directory (``schemas/healthdcatap/``) are licensed under Creative Commons Attribution 4.0 International (CC BY 4.0) as stated by the [HealthDCAT-AP Release 5 publication](https://healthdataeu.pages.code.europa.eu/healthdcat-ap/releases/release-5/#speclicence). See [``LICENSE``](./LICENSE) for further details.
